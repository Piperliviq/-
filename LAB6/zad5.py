...
animal_9 = Cat("Afrodita", 4, "fish")
animal_10 = Duck("Blake", 7, "grass")

list_animals = [animal_1, animal_2, animal_3, animal_4, animal_5, animal_6, animal_7, animal_8, animal_9, animal_10]
